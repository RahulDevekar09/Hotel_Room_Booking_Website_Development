                ...
                <form id="login-form" method="POST" action="login_register.php">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-none" name="email_username" required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2 ">
                            <button type="submit" class="btn btn-dark shadow-none login-btn" name="login">
                                LOGIN
                            </button>
                ...
                <form id="register-form">
                    ...
                    <div class="modal-body">
                        <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                            Note: Your details must match with your ID(Adhaar card, password, driving licence) that will be required during check-in.
                        </span>
                        <div class="container-fluid">
                            <dic class="row">
